...
def intro():
    ...
    print("Rules: Player 1 and Player 2 use C and S, take turns "
          "filling the spaces in a 3*3 grid. The player who succeeds in placing "
...
# This function decides the players' symbols
    symbol_1 = input("Player 1, do you want to be C or S? ")
    if symbol_1 == "C":
        symbol_2 = "S"
        print("Player 2, you are S. ")
    else:
        symbol_2 = "C"
        print("Player 2, you are C. ")
    input("Press enter to continue.")
    print("\n")
